...
import com.example.ocrdemo.MainActivity;
...
//  }
  ...
  public boolean onContextItemSelected(MenuItem item) {
   ...
   Log.e("Tag", "copy " + ocrResultView.getText().toString());
...
//      }
  ...
  public void addingPrefixSuffix(View v)
  {
	  ReuseableClass.saveInPreference("OCRresult",   ocrResultView.getText().toString(), this);
